...
public:
    ...
    {
        // Eleocoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Eleocoin: get transaction coin age
...
public:
    ...
    // Eleocoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Eleocoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Eleocoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Eleocoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Eleocoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Eleocoin: block index flags
    enum  
    {
